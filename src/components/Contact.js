...
export const Contact = () => {
    ...
    const handleSubmit = async(e) => {
        ...
        if (result.code === 200) {
            ...
            setStatus({ success: false, message: 'Algo deu errado, favor tentar novamente mais tarde.'})
        }
    };
                    ...
                    <Col md={6}>
                        ...
                        <form onSubmit={handleSubmit}>
                            <Row>
                                ...
                                <Col>
                                    <textarea row="6" value={formDetails.message} placeholder="Digite sua Mensagem" onChange={(e) => onFormUpdate('message', e.target.value)} />
