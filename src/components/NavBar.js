          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                  <a href="https://www.linkedin.com/in/vin%C3%ADcius-gabriel-8336321b6"><img src={navIcon1} alt="" /></a>
                  <a href="https://github.com/Vincius-dev"><img src={navIcon2} alt="" /></a>
                  <a href="mailto:vinicius.fariascontato@gmail.com"><img src={navIcon3} alt="" /></a>
              </div>
              <HashLink to='#connect'>
